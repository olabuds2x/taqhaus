      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2 space-y-4">
            <img src="/taqhaus-logo.png" alt="TaqHaus" className="h-[44px] w-auto" />
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-ink-muted tracking-wider uppercase font-label">
          ...
          <a href="mailto:info@taqhaus.com" className="hover:text-white transition-colors">info@taqhaus.com</a>
        </div>
      </div>
    </footer>
  )
